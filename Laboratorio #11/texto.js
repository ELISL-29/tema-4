...
if (!isNaN(montoCompra) && montoCompra >= 0) {
    if (montoCompra > 100) {
        let descuento = montoCompra * 0.10; // Calcula el 10% de descuento
        let montoFinal = montoCompra - descuento; // Aplica el descuento
...
let intentoUsuario = prompt("Adivina el número (entre 1 y 10):");
